...
{
	struct bpf_thread_wq_ctx *ctx = container_of(work, struct bpf_thread_wq_ctx, destroy_work);
...
{
	struct bpf_thread_wq_ctx *ctx = container_of(rcu, struct bpf_thread_wq_ctx, rcu);
